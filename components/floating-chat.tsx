  ...
  return (
    <>
      ...
      <button
        ...
        className="floating-chat-button fixed bottom-6 right-6 z-50 bg-purple-600 hover:bg-purple-700 text-white rounded-full p-4 shadow-lg transition-all duration-300 flex items-center justify-center"
      >
      ...
      {isOpen && (
        <div
          ...
          className="fixed bottom-24 right-6 z-40 w-full max-w-[350px] sm:max-w-[400px] bg-navy-900/95 border border-navy-800 rounded-lg shadow-xl transition-all duration-300 flex flex-col"
